...
import { X, Bell, CheckCircle, CreditCard, UserPlus, Package, Info, AlertTriangle, MessageSquare, Check, Trash2 } from 'lucide-react';
        ...
        <div className="p-4 border-b border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              ...
              <h3 className="ml-2 text-lg font-medium text-gray-900 dark:text-white">Notifications</h3>
              {unreadCount > 0 && (
          ...
          <div className="mt-2 flex justify-end space-x-2">
            <button
              ...
              className="p-1.5 rounded-full text-gray-600 hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-gray-200 dark:hover:bg-gray-700"
