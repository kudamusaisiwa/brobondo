...
export default function MentionList({ users, searchTerm, onSelect, position }: MentionListProps) {
  ...
  return (
    <div 
      className="fixed z-50 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 max-h-48 overflow-y-auto w-64"
      style={{ 
        top: position.top - 200, // Position above the input
        left: position.left,
