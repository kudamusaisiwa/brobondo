      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="flex-1 relative">
          <TextareaAutosize
            ...
            className="w-full rounded-lg border border-gray-300 dark:border-gray-600 p-2.5 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
            minRows={1}
            maxRows={5}
          />
